...
/* main program to display parallel corsika ECUTMAX parameters:
*************************************************************************/
   ...
   // - - - - energy >= 1.00e5 GeV:
      ...
      for( irat=-1; irat<=7; irat+=2 ) {  
         ...
         if ( cfactor*Energy/Eratio < 34567. && mfiles != ifiles ) 
           if ( Eratio > 1.e4 )  
             printf(
             " %8.4f %12.4e %5d. %7.0f. %11.1e         %6.0f. %8.1f \n",
               elog10, Energy, iprc, Eratio*1.e-3, Eratio,
               cfactor*Energy/Eratio, Energy/Eratio);
           else 
             printf(
             " %8.4f %12.4e %5d. %8.1f %11.1e         %6.0f. %8.1f \n",
               elog10, Energy, iprc, Eratio*1.e-3, Eratio,
               cfactor*Energy/Eratio, Energy/Eratio); 
         printf("                                                     "
                "      %6.0f.\n",2.39*Ratio+5.234);
