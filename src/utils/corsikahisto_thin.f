C=======================================================================
C
C  c o r s i k a h i s t o _ t h i n . f  with "thinning" (and possibly history)
C           ====================================================
...
c             WRITE(*,'(1P,8E16.8)') (PDATA(II+IL),II=0,7)
             ...
             if(idc.gt.0)then
               id=idc/1000
               if(id.ne.75.and.id.ne.76.id.ne.85.and.id.ne.86)then
                 idi=idtrafo('cor','nxs',id)
                 if(id.ne.95.and.id.ne.96)then
...
c           if(mod(gen,1000d0).gt.100)print *,gen,idc,id1,id0,gen0,gen1
                 ...
                 else    !final state of decayed muon
