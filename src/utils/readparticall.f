...
c-----------------------------------------------------------------------
      ...
      character cdata(10000)*250,cdat*250
...
c----------------subblock event end-------------------------------------
      elseif ( 3397.3 .le. pdata(lia).and.pdata(lia) .le. 3397.5 ) then 
         ! activate print out only in case of problems:
         if ( isho .lt. 0 ) write(*,*) '       isub=',isub,
     +      ' (evte)    irec=',irec,'    isho =',isho
c----------------subblock run end---------------------------------------
