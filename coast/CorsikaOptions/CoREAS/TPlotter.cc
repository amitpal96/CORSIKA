...
/*  this warning message is somewhat misleading for users, better remove it
...
#define MASTER 0
  ...
  // check if the simulation has actually run, otherwise abort as collection of results is impossible
  if (!itsScenarioParams)
  {
    cout << "Simulation on rank " << rank << " was never initialized (received no particles)! Aborting ..." << endl;
